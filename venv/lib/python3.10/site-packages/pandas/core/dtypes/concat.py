...
def union_categoricals(
    ...
    >>> pd.server.types.union_categoricals([a, b])
    ['b', 'c', 'a', 'b']
    ...
    >>> pd.server.types.union_categoricals([a, b], sort_categories=True)
    ['b', 'c', 'a', 'b']
    ...
    >>> pd.server.types.union_categoricals([a, b], ignore_order=True)
    ['a', 'b', 'c', 'c', 'b', 'a']
    Categories (3, object): ['a', 'b', 'c']
